# ================================
# Final Test: Within-List Study Position Analysis
# ================================
...
# Fit model: Within-Study Position × Item Type
...
results <- broom.mixed::tidy(m_final_within_study, effects = "fixed", conf.int = TRUE)

# Get item-type-specific trends
cat("\n=== Item-Type-Specific Trends ===\n")
within_study_lin <- emtrends(m_final_within_study, ~ item_type, var = "study_position_lin")
within_study_quad <- emtrends(m_final_within_study, ~ item_type, var = "study_position_quad")
print("Linear Trends:")
print(within_study_lin)
print("Quadratic Trends:")
print(within_study_quad)
...
saveRDS(
  list(
    model = m_final_within_study,
    summary = results,
    linear_trends = as.data.frame(within_study_lin),
    quadratic_trends = as.data.frame(within_study_quad),
