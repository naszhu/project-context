# ================================
# Final Test: Between-List Initial Order Analysis (FAST VERSION FOR TESTING)
# ================================
...
if (SIMPLIFIED_MODEL) {
  ...
  m_between_initial <- glmer(
    accuracy ~ initial_order_lin * item_type + initial_order_lin * condition +
