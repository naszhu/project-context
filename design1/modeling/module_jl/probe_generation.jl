...
function generate_probes(
    ...
    # STEP 2: Content distortion disabled (is_content_distort_between_study_and_test = false)
    probe_words_before_distort = deepcopy(probe_words)
    probe_words_after_distort = deepcopy(probe_words)
