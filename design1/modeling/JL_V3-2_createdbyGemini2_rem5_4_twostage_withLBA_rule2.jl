#= ===========================================================================================================
   ...
   Notes       : This version change from with_LBA, [add pj rule 2], which is probability of passing to stage 2. This version focus on first stage exploration, so second stage is not working here
                 ...

                 This version has to modify g_context to equal g_word because of second stage likliehood calculation
                 word_likelihoods[ii] = calculate_likelihood_ratio(vcat(probe.word.word_features,probe.context_features), vcat[image.word.word_features,image.context_features], g_word, c)
   =========================================================================================================== =#
