...
criterion_initial =  LinRange(1, 0.85, n_probes);#the bigger the later number, more close hits and CR merges. control merging  
...
n_studytest_change = round.(Int,ones(10)*13)
