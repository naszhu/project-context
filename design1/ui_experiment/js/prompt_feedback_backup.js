var is_debug = false;
 ...
 //same as above, but created to only used in for loop below
    ...
    var instructions_finaltest = {
      type: jsPsychHtmlKeyboardResponse,
      stimulus: text_a.concat(finalint_text.concat("<p style='text-align: justify;color: black;background: white;font: caption-; paddingRight =20px; paddingLeft =20px''>start the test list with the ‘enter’ key</p>")),
      post_trial_gap: posgap_duration,
      trial_duration: instruction_duration,
      choices: choiceenter
    };
     ...
     **********************************************************************************/
      ...
      var v_study = {
        ...
        prompt: function(){
          if (condi!="r")
          return "<p>The current trial number: ".concat(i_trial+1).concat("</p>");
          else return ""
        },
        choices: "NO_KEYS",
            ...
            if (lastresp.task == "pretest_response"){
              ...
              if (condi!="r")
                return '<p color: black;background: white;><strong>"F" for new&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;"J" for old</strong></p>'.concat(
                  ...
                  Math.round(lastresp.accumulated_accuracy*100)).concat("%").concat(
                    "<p>The current trial number: ").concat(i_trial+1).concat("</p>");
              else
                return '<p color: black;background: white;><strong>"F" for new&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;"J" for old</strong></p>'.concat(
                  "Your accumulated accuracy for this trial is: ").concat(
        ...
        prompt: function(){
            ...
            if (lastresp.task == "finalt_response"){
              ...
              if (condi!="r")
                return '<p color: black;background: white;><strong>"F" for new&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;"J" for old</strong></p>'.concat(
                  "Your accumulated accuracy for this trial is: ").concat(
                    Math.round(lastresp.accumulated_accuracy*10000)/100).concat("%").concat(
                    "<p>The trial number in previous tests if this is a picture that have shown: ").concat(
                      jsPsych.timelineVariable('prespos_itrial')).concat("</p>");
              else return '<p color: black;background: white;><strong>"F" for new&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;"J" for old</strong></p>'.concat(
                  "Your accumulated accuracy for this trial is: ").concat(
                    Math.round(lastresp.accumulated_accuracy*10000)/100).concat("%")
