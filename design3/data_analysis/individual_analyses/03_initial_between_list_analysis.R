# ================================
# Initial Test: Between-List Analysis
# ================================
...
results <- broom.mixed::tidy(m_init_between_e3, effects = "fixed", conf.int = TRUE)

# Get item-type-specific trends
cat("\n=== Item-Type-Specific Trends ===\n")
between_lin_trend <- emtrends(m_init_between_e3, ~ item_type, var = "list_number_lin")
between_quad_trend <- emtrends(m_init_between_e3, ~ item_type, var = "list_number_quad")
print("Linear Trends:")
...
between_emmeans <- emmeans(m_init_between_e3, ~ item_type)
