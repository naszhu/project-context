...
///////////////////////////////
    ...
    const num_tottest_finaltest = 90;
    ...
    const num_listtotest = 6;
    const numlists = 10;
    const num_pairlists_usedinFinal = 3;
...
//****************************************************
    ...
    var v_digitresponse = {//nondebug
        ...
        // is_correct: ;
        trialnum: i_trial+1,
        listnumber_1to10: i_trial+1,//changes being made here
        pairs_which_1or2: (i_trial+1)%2 ===0 ? 2 : 1,//changes being made here
        listgroup_1to5: Math.ceil((i_trial+1)/2) //changes being made here
        }
    };
    ...
    * ...
    ...
    on_finish: function(data){
        ...
        data.is_correct_word1 = wordchosen_finaltest.includes(data.wordanswer_first) && true;
        data.is_correct_word2 = wordchosen_finaltest.includes(data.wordanswer_second) && !data.is_repeatanswer;
        data.is_correct_word12_precise = data.is_correct_word1 && data.is_correct_word2;
