...
df1 = read.csv(here("design2","data","stored/1-4-24, to v10 frandom-fr.csv"))%>%
  mutate(responsesum=as.integer(responsesum))
df2 = read.csv(here("design2","data","stored/1-5-24, v10 visualexp-bakcward.csv"))%>%
  mutate(responsesum=as.integer(responsesum))
df3 = read.csv(here("design2","data","stored/1-5-24, v10 visualexp-forward.csv"))%>%
  mutate(responsesum=as.integer(responsesum))
df11 = read.csv(here("design2","data","stored/1-5-24, v10 visualexp-frandom -br.csv"))%>%
  mutate(responsesum=as.integer(responsesum))
df111 = read.csv(here("design2","data","stored/1-5-24, v10 visualexp-random.csv"))%>%
  mutate(responsesum=as.integer(responsesum))
df112 = read.csv(here("design2","data","temp.csv"))%>%
  mutate(responsesum=as.integer(responsesum))


df10 = read.csv(here("design2","data","stored/temp/b.csv"))%>%
  mutate(responsesum=as.integer(responsesum))

df20 = read.csv(here("design2","data","stored/temp/f.csv"))%>%
  mutate(responsesum=as.integer(responsesum))

df30 = read.csv(here("design2","data","stored/temp/fr.csv"))%>%
  mutate(responsesum=as.integer(responsesum))

df40 = read.csv(here("design2","data","stored/temp/r.csv"))%>%
  mutate(responsesum=as.integer(responsesum))
...
# m=(dcp == dfcg)%>%as_tibble()

m['tasks']
summary(m$correct_all)
...
dfnew33 = df_conditioned_joined %>%
  ...
  group_by(condition,wordcondi, q,listnum,correct_pretest)%>%
