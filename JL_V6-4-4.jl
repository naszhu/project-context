...
--------------
modify from, and delete all println from   "JL_V6-4-3  new by shifrin_printLogSave.jl"
---------------------------------
Current file solved initial test problem and next file is to modify based on this for final test prediction
=========================================================================================================== =#
...
# -------------------------------
criterion_final = LinRange(0.22, 0.4, 10)
final_gap_change = 0.2;
