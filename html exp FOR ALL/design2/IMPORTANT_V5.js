...
///////////////////////////////
    ...
    if (is_debug) {
      ...
      var feedbackmes_wordfinal_duration = 1200; 
...
//****************************************************
    ...
    * ...
    ...
    questions: function(){
        ...
        prompt: "".concat(`Type <strong>the whole word</strong> you studied in <strong>ALL</strong> previous lists, starting with <strong>"`,ftlnow,`</strong>`,`________"<br><br> Press 'enter' key to go to next blank or next cues`,"<br><br>The first word if you remember:"), //changed!!
        placeholder:``.concat(`type the word starting with '`,JT('ftl'),`' or 'none'`),
        required: true
        }, 
        {
    ...
    stimulus: function(){
        ...
        iscorrect2 = lasttrial_obj.word2_response==='none' && lasttrial_obj.is_correct_second? ''.concat(iscorrect2, "There is ", concatfont("NO second word "), "studied") : iscorrect2; 
        iscorrect2 = lasttrial_obj.word2_response==='none' && !lasttrial_obj.is_correct_second? ''.concat(iscorrect2, "There is ", concatfont("a second word "), "studied") : iscorrect2; 
        ...
        if (lasttrial_obj.word1_response!=='none' && lasttrial_obj.word2_response!=='none' && !lasttrial_obj.is_correct_second && lasttrial_obj.wordcondi==="unique") {
            ...
            iscorrect2=''.concat(iscorrect2, "There is ", concatfont("NO second word "), "studied")
        }
