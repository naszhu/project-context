    ...
    const info = {
      ...
      parameters: {
        ...
        trial_duration: {
          ...
          },            //////// this is the parameter I added as mentioned in this post.
      },
    };
      ...
      trial(display_element, trial) {
        ...
        if (trial.trial_duration !== null) {
          jsPsych.pluginAPI.setTimeout(function() {
            display_element.querySelector('#jspsych-survey-text-next').style.visibility = 'visible'; ///// this is what I used instead of requestSubmit().
