#= ===========================================================================================================
   ...
   Notes       : This is for the one stage, but only one list, regular Appendix B REM. 
                 ...
   =========================================================================================================== =#
...
b_initial = 0.20 #proportion of context features(common)
...
const p_listchange_finalstudy = 0.5; #either of these contribute to differences between list 
...
function simulate_rem()
    ...
    for sim_num in 1:n_simulations
        ...
        studied_pool = Array{EpisodicImage}(undef, 20+10,n_lists); #30 images (10 Tt, 10 Tn, 10 Tf) of 10 lists
        ...
        for list_num in 1:n_lists
            ...
            #  assume there is a change of features between study and test
            ...
            general_context_features .= ifelse.(rand(length(list_change_context_features)) .<  p_listchange_finalstudy,rand(Geometric(g_context),length(general_context_features)) .+ 1,general_context_features)


            probes = generate_probes(word_list, deepcopy(list_change_context_features), deepcopy(general_context_features), list_num);
...
facet_grid(list_number~.)+ylim(c(0,1))
